...
bool sendMess(){
    ...
    addNewMess_db(receiver, mess);
    char* request = SengMessegeMaker("3112", receiver, mess);
...
void CommandHandler(){
    ...
    char functions_name[100][100] = {"/friends", "/add", "/dell", "/exit",
                                     "/send", "/show"};
    bool (*function_pointers[6])()= {ShowFreinds, AddNewFriend, DelHandler, Exit,
                                     SendNewObject, ShowHandler};
